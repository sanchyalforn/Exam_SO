/*
Programa que muestra como el puntero de lectura/escritura es compartido entre dos procesos si el open se ejecuta antes del fork.
 La suma de los resultados de los dos procesos es el total de A's. HAY QUE EJECUTARLO EN UNA MAQUINA UNIX, NO LINUX.
*/
